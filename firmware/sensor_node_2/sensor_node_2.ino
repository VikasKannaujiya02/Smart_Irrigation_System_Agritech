/* =====================================================================
   Sensor Node 2  –  AI Smart Irrigation Digital Twin
   Device ID : 0x0003
...
void setup() {
  ...
  delay(300);
  Serial.println();
  Serial.println("=== Sensor Node 2 Boot (0x0003) ===");
  ...
  Serial.println("[SYSTEM] NODE2 ready – telemetry starting");
}
